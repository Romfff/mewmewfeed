...
const translations = {
  en: {
    ...
    claimBonusBtn: 'Claim +30% EXP',
    claimBonusDesc: '(Requires visiting ad page, 5m cooldown)',
    cooldownError: 'Please wait 5 minutes before claiming again!',
  ...
  vi: {
    ...
    levelUp: 'Lên Cấp',
    reachedLevel: 'Mèo của bạn đã đạt Cấp độ',
    claimRewardText: 'Nhận thưởng bên dưới:',
    claimRewardBtn: 'Nhận Thưởng (+10% EXP)',
    claimBonusBtn: 'Nhận +30% Điểm',
    claimBonusDesc: '(Phải xem quảng cáo, hồi chiêu 5 phút)',
    cooldownError: 'Vui lòng đợi 5 phút để nhận lại phần thưởng!',
